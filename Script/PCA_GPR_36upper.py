...
def main():
    ...
    print("目标2: PCA辅助筛选36个特征 -> GPR")
    print("原始特征数:", X_all.shape[1])
    print("样本数:", X_all.shape[0])
    print(f"筛选规则: score={FEATURE_SCORE_METHOD}, mode={FEATURE_SELECT_MODE}, top_ratio={TOP_RATIO}")
    ...
    save_metrics_csv(
        ...
        extra_dict={
            "method": "PCA_select_36upper_then_GPR",
            "n_samples": len(y),
